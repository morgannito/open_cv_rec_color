...
while (1):
    ...
    #                     1.0, (255, 0, 0))
        ...
        # Creating contour to track yellow
    ...
    # Creating contour to track white
    ...
    for pic, contour in enumerate(contours):
        ...
        if len(approx) == 3:
            ...
            print("hexagon")
            # cv2.putText(imageFrame, 'Pentagon', (x, y),
            #             cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)

        elif len(approx) == 6:
            print("hexagon")
            # cv2.putText(imageFrame, 'Hexagon', (x, y),
            #             cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
    ...
    if(good_color & good_shape & good_quadri):
